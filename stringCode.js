...
function soundPlayer() {
    console.log("soundPlayer has started");
    mySound = new sound("intro.mp3");
    console.log("playing 'intro.mp3' function");
    mySound.play();
}

function coolSound() {
    console.log("coolSound has started");
    mySound1 = new sound("healthPickUp.mp3");
    console.log("playing 'healthPickUp.mp3' function");
    mySound1.play();
}
...
//set the source for the src file
    this.sound.src = srcFile;
//load the audio
    this.sound.setAttribute("preload", "audio");
    this.sound.setAttribute("controls", "none");
//add the preload and controls to 'this.sound'
    document.body.appendChild(this.sound);
    this.play = function(){
//get this sound and play it
        this.sound.play();
    }
//get this sound and end it
    this.stop = function(){
        this.sound.pause();
    }
}
